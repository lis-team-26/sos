(function () {
  var fallbackData = {
    counts: { total: 0, success: 0, error: 0, unknown: 0 },
    results: [],
    manifestErrors: []
  };
  ...
  function statusBadge(status, label) {
    var cls = status === "success" ? "text-bg-success" : status === "error" ? "text-bg-danger" : "text-bg-secondary";
  ...
  function renderResultCard(result) {
    var card = element("article", "card mb-2 shadow-sm");
